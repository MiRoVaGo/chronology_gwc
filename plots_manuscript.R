...
p01 <- ggplot(data = gwc_data, aes(x = Author, y = P_L)) +
  ...
  labs(x = NULL, y = expression(paste("Precipitation overland in ", 10^3, "[", km^3, "/", year, "]"))) +
  theme_bw() +
  scale_y_continuous(limits = c(0, 150), expand = c(0, 0)) +
  theme(legend.position = c(0.5, 0.92), legend.text = element_text(size = 16, face = "bold"), legend.direction = "horizontal", panel.grid.major.x = element_blank(), axis.text.y = element_text(face = "bold", size = 14), axis.title.y = element_text(face = "bold", size = 18), axis.text.x = element_text(face = "bold", angle = 90, size = 10, hjust = 1, vjust = 0.5), axis.ticks.x = element_blank())
...
p04 <- ggplot(data = gwc_data, aes(x = Author, y = P_O)) +
  geom_bar(stat="identity") +
  labs(x = NULL, y = expression(paste("Precipitation over oceans in ", 10^3, "[", km^3, "/", year, "]"))) +
  theme_bw() +
...
p05 <- ggplot(data = gwc_data, aes(x = Author, y = E)) +
  geom_bar(stat="identity") +
  labs(x = NULL, y = expression(paste("Evaporation over oceans in ", 10^3, "[", km^3, "/", year, "]"))) +
  theme_bw() +
...
p08 <- ggplot(data = gwc_data[,1:6] %>% melt() %>% na.omit(), aes(x = variable, y = value)) +
  ...
  theme_bw() +
  scale_y_continuous(limits = c(0, 550), expand = c(0, 0)) +
  theme(legend.position = "none", panel.grid.major.x = element_blank(), axis.text = element_text(face = "bold", size = 16), axis.title = element_text(face = "bold", size = 18))
...
p09 <- ggplot(data = land_data, aes(x = Author, y = value, color = variable, group = variable)) +
  geom_line(size = 2) + geom_point(aes(fill = variable), shape = 21, colour = "black", size = 2, stroke = 1, show.legend = FALSE) + 
  labs(color = NULL, x = NULL, y = expression(paste("Fluxes overland in ", 10^3, "[", km^3, "/", year, "]"))) +
  theme_bw() +
...
p10 <- ggplot(data = ocean_data, aes(x = Author, y = value, color = variable, group = variable)) +
  geom_point(aes(fill = variable), shape = 21, colour = "black", size = 2, stroke = 1, show.legend = FALSE) + 
  geom_line(data = ocean_data %>% subset(!is.na(value)), size = 2) + geom_point(aes(fill = variable), shape = 21, colour = "black", size = 2, stroke = 1, show.legend = FALSE) +
  labs(color = NULL, x = NULL, y = expression(paste("Fluxes over oceans in ", 10^3, "[", km^3, "/", year, "]"))) +
  theme_bw() +
...
p11 <- ggplot(data = gwc_data, aes(x = Author, y = idx, group = 1, color = "#984ea3", fill = "#984ea3")) +
  geom_point(shape = 21, colour = "black", size = 2, stroke = 1, show.legend = FALSE) + 
  geom_line(data = gwc_data[-37,], size = 2) + geom_point(shape = 21, colour = "black", size = 2, stroke = 1, show.legend = FALSE) +
  ...
  theme(legend.position = "none", panel.grid.major.x = element_blank(), axis.title.y = element_text(face = "bold", size = 18), axis.text.y = element_text(face = "bold", size = 16), axis.text.x = element_text(angle = 90, size = 10, hjust = 1, vjust = 0.5, face = "bold"), axis.ticks.x = element_blank())
...
p12 <- ggplot(data = land_data, aes(x = value, group = variable, fill = variable)) +
  ...
  labs(fill = NULL, y = "Density", x = expression(paste("Fluxes overland in ", 10^3, "[", km^3, "/", year, "]"))) +
  theme_bw() +
  ...
  theme(legend.position = c(0.5, 0.94), legend.text = element_text(size = 16, face = "bold"), legend.direction = "horizontal", axis.text.y = element_text(face = "bold", size = 16), axis.text.x = element_text(face = "bold", size = 16), axis.title.y = element_text(face = "bold", size = 18), axis.title.x = element_text(face = "bold", size = 18))
...
p13 <- ggplot(data = ocean_data, aes(x = value, group = variable, fill = variable)) +
  ...
  theme_bw() +
  scale_fill_manual(values = c("#1f78b4", "#33a02c", "#a6cee3", "#31A9B8", "#486B00", "#258039", "#A2C523")) +
  scale_y_continuous(limits = c(0, 0.012), expand = c(0, 0)) +
  scale_x_continuous(limits = c(242, 505), expand = c(0, 0)) +
  theme(legend.position = c(0.65, 0.97), legend.text = element_text(size = 16, face = "bold"), legend.direction = "horizontal", axis.text.y = element_text(face = "bold", size = 16), axis.text.x = element_text(face = "bold", size = 16), axis.title.y = element_text(face = "bold", size = 18), axis.title.x = element_text(face = "bold", size = 18))
